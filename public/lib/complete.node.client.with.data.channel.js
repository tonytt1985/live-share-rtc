...
var pc_config = webrtcDetectBrowser === 'firefox' ? {iceServers: [{'url': 'stun:192.168.1.204'}]} : {iceServers: [{'url': 'stun:stun.l.google.com:19302'}]};
...
socket.on('message', function(message){
    ...
    if(message.type === 'got user media'){
        ...
        pc.setRemoteDescription(new RTCSessionDesciption(message));
        doAnswer();
...
function createPeerConnection(){
    ...
    if(isInitiator){
        ...
        //Joiner
        pc.ondatachanel = gotReceiveChannel;
    }
}
...
function gotReceiveChannel(event){
    ...
    receiveChannel.onmessage = hanldeMessage;
...
function setLocalAndSendMessage(sessionDescription){
    pc.setLocalSescription(sessionDescription);
